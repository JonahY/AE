...
# ----------------------------------------------------- Alpha 1.3 ------------------------------------------------------
staLen, overlap, staWin, IZCRT, ITU, alpha, t_backNoise = 2, 1, 'hamming', 0.3, 650, 1.3, 50
t_str, t_end = 50, 1e7
t = t_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1] - t_initial[int(t_str // t_initial[1])]
sig = sig_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1]
...
# ----------------------------------------------------- Alpha 1.9 -----------------------------------------------------
staLen, overlap, staWin, IZCRT, ITU, alpha, t_backNoise = 2, 1, 'hamming', 0.3, 650, 1.9, 50
t_str, t_end = 50, 1e7
t = t_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1] - t_initial[int(t_str // t_initial[1])]
sig = sig_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1]
...
# ------------------------------------------------------ ITU 450 -------------------------------------------------------
staLen, overlap, staWin, IZCRT, ITU, alpha, t_backNoise = 4, 0, 'hamming', 0.2, 450, 1.3, 0
t_str, t_end = 0, 1e7
t = t_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1] - t_initial[int(t_str // t_initial[1])]
sig = sig_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1]
...
# ------------------------------------------------------ ITU 650 -------------------------------------------------------
staLen, overlap, staWin, IZCRT, ITU, alpha, t_backNoise = 4, 0, 'hamming', 0.2, 650, 1.3, 0
t_str, t_end = 0, 1e7
t = t_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1] - t_initial[int(t_str // t_initial[1])]
sig = sig_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1]
...
# ------------------------------------------------------ ITU 850 -------------------------------------------------------
staLen, overlap, staWin, IZCRT, ITU, alpha, t_backNoise = 4, 0, 'hamming', 0.2, 850, 1.3, 0
t_str, t_end = 0, 1e7
t = t_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1] - t_initial[int(t_str // t_initial[1])]
sig = sig_initial[int(t_str // t_initial[1]):int(t_end // t_initial[1]) + 1]
