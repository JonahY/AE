...
class TrainVal():
    def __init__(self, config):
        ...
        #      transforms.ToTensor()])
        self.train_transform = transforms.Compose([transforms.Resize(192), transforms.ToTensor()])
        self.test_transform = transforms.Compose([transforms.Resize(192), transforms.ToTensor()])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_path', type=str, default='/home/Yuanbincheng/project/dislocation_cls/20220225/2022-02-26T12-36-12-classify-fold9_best_0.0002481.pth')
