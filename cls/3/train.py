...
class TrainVal():
    def __init__(self, config):
        ...
        #      transforms.ToTensor()])
        self.train_transform = transforms.Compose([transforms.Resize(112), transforms.ToTensor()])
        self.test_transform = transforms.Compose([transforms.Resize(112), transforms.ToTensor()])
